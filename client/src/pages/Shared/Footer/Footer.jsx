...
const Footer = () => {
    return (
        <footer className="mt-16 overflow-hidden rounded-3xl bg-secondary text-white">
            <div className="grid gap-8 px-8 py-12 md:grid-cols-4">
            ...
            <div className="flex flex-col items-center justify-between gap-2 border-t border-white/10 px-8 py-4 text-xs text-white/60 sm:flex-row">
                <p>Copyright © {new Date().getFullYear()} ZapShift — All rights reserved</p>
                <div className="flex gap-4">
                    <Link to="/help" className="hover:text-primary">Privacy & Terms</Link>
